package tw.org.iii.lipin.foodsharing.TakeHistoryFragment;
...
public class getRequestRecord extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            sql = "select fht.*,fc.*,us.account,us.img,us.username,us.token" +
                    ...
                    " where fht.takeornot = ?" +
                    " and fht.user_id = ?" +
                    " order by fht.createtime desc ";
            List<Map<String,Object>> maps = template.queryForList(sql,1,userid);
